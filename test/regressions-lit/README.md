...
`pnpm test:regressions:lit:dev` will build all Lit fixtures and render an overview page that lists all fixtures.
...
| command                        | description                                                                                                           |
| :----------------------------- | :-------------------------------------------------------------------------------------------------------------------- |
| `pnpm test:regressions:lit`        | Full run                                                                                                                      |
| `pnpm test:regressions:lit:dev`    | Prepares the Lit fixtures and runs a Vite dev server                                                                          |
| `pnpm test:regressions:lit:run`    | Runs the tests (requires `pnpm test:regressions:lit:dev` or `pnpm test:regressions:lit:build`+`pnpm test:regressions:lit:server`) |
| `pnpm test:regressions:lit:build`  | Builds the Vite bundle for viewing Lit fixtures                                                                               |
| `pnpm test:regressions:lit:server` | Serves the Lit fixture bundle.                                                                                                |
