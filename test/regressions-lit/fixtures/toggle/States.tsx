...
import { svg } from 'lit';
import { LitToggle } from 'docs/src/app/(docs)/lit/components/toggle/demos/hero/LitToggle';
  ...
  return (
    ...
    >
      <div className={styles.Panel}>
        <LitToggle aria-label="Favorite on" className={styles.Button} pressed>
          {heartFilledIcon()}
        </LitToggle>
      </div>
      <div className={styles.Panel}>
        <LitToggle aria-label="Favorite off" className={styles.Button} pressed={false}>
          {heartOutlineIcon()}
        </LitToggle>
      </div>
      <div className={styles.Panel}>
...
function heartFilledIcon() {
  return svg`<svg class=${styles.Icon} width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
