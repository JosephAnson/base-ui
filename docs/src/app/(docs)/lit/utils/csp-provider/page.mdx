...
```html title="Anatomy"
<script type="module">
  import '@base-ui/lit/csp-provider';
</script>
...
```html title="Providing the nonce"
<script type="module">
  import '@base-ui/lit/csp-provider';
</script>
...
```html title="Disabling style elements"
...
3. Manually unset inline styles and specify them in your CSS instead. Note that you'll need to ensure you vet upgrades for any new inline styles added by Base UI components.
