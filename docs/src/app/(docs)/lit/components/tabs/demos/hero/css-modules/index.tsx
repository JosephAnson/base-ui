...
import styles from 'docs/src/app/(docs)/react/components/tabs/demos/hero/css-modules/index.module.css';
...
export default function ExampleTabs() {
  ...
  React.useEffect(() => {
    ...
    renderTemplate(
      html`<tabs-root class=${styles.Tabs} .defaultValue=${'overview'}>
        <tabs-list class=${styles.List}>
          <tabs-tab class=${styles.Tab} value="overview">Overview</tabs-tab>
          <tabs-tab class=${styles.Tab} value="projects">Projects</tabs-tab>
          <tabs-tab class=${styles.Tab} value="account">Account</tabs-tab>
          <tabs-indicator class=${styles.Indicator}></tabs-indicator>
        </tabs-list>
        <tabs-panel class=${styles.Panel} value="overview">
          ${overviewIcon(styles.Icon)}
        </tabs-panel>
        <tabs-panel class=${styles.Panel} value="projects">
          ${projectIcon(styles.Icon)}
        </tabs-panel>
        <tabs-panel class=${styles.Panel} value="account">
          ${personIcon(styles.Icon)}
        </tabs-panel>
      </tabs-root>`,
      host,
    );
