...
function listIcon(ariaLabel: string, className: string) {
  return svg`<svg aria-label=${ariaLabel} class=${className} fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24">
    <path d="M3 5h.01" />
    <path d="M3 12h.01" />
    <path d="M3 19h.01" />
    <path d="M8 5h13" />
...
function userIcon(ariaLabel: string, className: string) {
  return svg`<svg aria-label=${ariaLabel} class=${className} fill="none" height="24" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24">
