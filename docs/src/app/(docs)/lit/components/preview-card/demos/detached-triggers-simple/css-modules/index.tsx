import { LitPreviewCardDetachedSimple } from '../../shared/LitPreviewCardDemos';
import styles from 'docs/src/app/(docs)/react/components/preview-card/demos/index.module.css';

export default function PreviewCardDetachedTriggersSimpleCssModulesDemo() {
  return (
    <LitPreviewCardDetachedSimple
